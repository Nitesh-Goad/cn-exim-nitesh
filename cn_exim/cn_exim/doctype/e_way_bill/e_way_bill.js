...
//                 // Step 1: BOE fetch karo
//                 frappe.call({
//                     method: "frappe.client.get",
//                     args: {
//                         doctype: "BOE Entry",
//                         name: frm.doc.doctype_id   // BOE ID
//                     },
...
//                         // 🔥 BOE child table mapping (same as BOE button)
//                         if (boe.boe_entries) {
//                             boe.boe_entries.forEach(row => {
//                                 items.push({
...
//                         // Step 2: Create PO Condition Change
//                         frappe.call({
//                             method: "frappe.client.insert",
//                             args: {
//                                 doc: {
...
//                                     // 🔗 LINKS
//                                     boe_entry_reference: boe.name,
//                                     e_way_bill: frm.doc.name,

//                                     // FULL BOE DATA
//                                     boe_no: boe.boe_no,
//                                     boe_date: boe.boe_date,
//                                     pre_alert_req: boe.per_alert_check,
//                                     pickup_req: boe.pickup_request,
//                                     rfq_number: boe.request_for_quotation,
//                                     vendor: boe.vendor,
//                                     vendor_name: boe.custom_vendor_name,
//                                     cha_vendor: boe.cha,
//                                     cha_name: boe.custom_cha_name,
//                                     exchange_rate: boe.exchange_rate,

//                                     bcd_amt: boe.bcd_amount,
//                                     h_cess_amt: boe.h_cess_amount,
//                                     sws_amt: boe.sws_amount,
//                                     igst_amt: boe.igst_amount,
//                                     total_duty: boe.total_duty,

//                                     freight_amt: boe.total_freight,
//                                     other_chrg: boe.other_charges,
//                                     total_inr_val: boe.total_inr_value,
//                                     accessible_val: boe.accessible_value,

//                                     check_list_date: boe.check_list_date,
//                                     job_number: boe.job_number,
//                                     ad_code: boe.ad_code,
//                                     penalty: boe.penalty,
...
//                                     // reverse link
//                                     frappe.db.set_value("E-way Bill", frm.doc.name, "po_condition_change", r.message.name);
